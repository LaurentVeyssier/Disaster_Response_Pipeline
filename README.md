...
Below is the overview of model performance in the various testing conditions. Saved model is XGBoost with 5 data augmentation steps (last column to the right). The model achieves __**above 80% unweighted F1 score on nearly all labels**__.
